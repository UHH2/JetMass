...
def load_tree(
    ...
    def filter_(x):
        return x in [
            'pt', 'eta', 'phi', 'mass', 'jecfactor', 'jecfactor_SD',
            'pt_1', 'eta_1', 'phi_1', 'mass_1', 'jecfactor_1',
            'mjet', 'pt_gen_ak8', 'msd_gen_ak8', 'weight', 'N2', 'IsMergedWZ',  'trigger_bits',  'jetpfid'
        ]
...
def dump_tiny_tree(
    ...
    events_sel_tosave = events[[x for x in ak.fields(events)
                                if x not in [
                                        'pt', 'eta', 'phi', 'mass',
                                        'pt_1', 'eta_1', 'phi_1', 'mass_1',
                                        'IsMergedWZ', 'N2', 'trigger_bits', 'jetpfid', 'jecfactor_1'
                                ]]]
