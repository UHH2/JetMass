...
if(__name__ == "__main__"):
    ...
    parser.add_argument("-w","--workspace",type=str,help="path to workspace ROOT-file. Should contain workspace names 'w'.")
    ...
    for cat in ws.cats:
        ...
        for iToy,toy in enumerate(ws.toys):
            ...
            toy_color = 46
            toy[cat].plotOn(frame,ROOT.RooFit.LineColor(toy_color),ROOT.RooFit.MarkerColor(toy_color),ROOT.RooFit.LineStyle(2),ROOT.RooFit.MarkerStyle(26))
            frame.Draw()
